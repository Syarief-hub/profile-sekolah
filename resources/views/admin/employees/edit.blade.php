                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" id="name" name="name" 
                                    ...
                                    placeholder="Contoh: Dr. H. Ahmad, M.Pd" value="{{ old('name', $employee->name) }}" required>
                            ...
                            <div>
                                ...
                                <select id="type" name="type" required class="w-full rounded-xl border-slate-200 shadow-sm focus:border-primary focus:ring focus:ring-primary/20 transition-colors py-3">
                                    <option value="Guru" {{ old('type', $employee->type) == 'Guru' ? 'selected' : '' }}>Guru (Pendidik)</option>
                                    <option value="Staf" {{ old('type', $employee->type) == 'Staf' ? 'selected' : '' }}>Staf TU (Kependidikan)</option>
                                    <option value="Pimpinan" {{ old('type', $employee->type) == 'Pimpinan' ? 'selected' : '' }}>Pimpinan Sekolah</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" id="position" name="position" 
                                    class="w-full rounded-xl border-slate-200 shadow-sm focus:border-primary focus:ring focus:ring-primary/20 transition-colors py-3" 
                                    placeholder="Contoh: Guru Matematika" value="{{ old('position', $employee->position) }}" required>
                            ...
                            <div>
                                ...
                                <input type="text" id="nip" name="nip" 
                                    class="w-full rounded-xl border-slate-200 shadow-sm focus:border-primary focus:ring focus:ring-primary/20 transition-colors py-3" 
                                    placeholder="Nomor Induk Pegawai" value="{{ old('nip', $employee->nip) }}">
                            ...
                            <div>
                                ...
                                <input type="number" id="order_number" name="order_number" 
                                    class="w-full rounded-xl border-slate-200 shadow-sm focus:border-primary focus:ring focus:ring-primary/20 transition-colors py-3" 
                                    placeholder="Contoh: 1" value="{{ old('order_number', $employee->order_number) }}">
                            ...
                            <div class="md:col-span-2 mb-1">
                                <label class="block text-sm font-bold text-slate-700 mb-2">Pas Foto</label>
                                <div class="flex items-center gap-6 p-4 bg-slate-50 border border-slate-200 rounded-2xl">
                                    <div class="flex-shrink-0">
                                        @if($employee->image)
                                            <img src="{{ Storage::url($employee->image) }}" alt="Foto" class="w-20 h-20 rounded-xl object-cover border border-slate-300 shadow-sm">
                                        @else
                                            <div class="w-20 h-20 rounded-xl bg-white border border-slate-300 text-slate-300 text-3xl flex items-center justify-center shadow-sm">
                                    ...
                                    <div class="w-full">
                                        <input type="file" id="image" name="image" accept="image/*"
                                            class="block w-full text-sm text-slate-500
                                              ...
                                              hover:file:bg-emerald-100 border border-slate-200 rounded-xl p-2 cursor-pointer bg-white transition">
                                        <p class="text-slate-400 text-xs mt-2">Biarkan kosong jika tidak ingin mengubah foto. Format: JPG, PNG mas 2MB.</p>
