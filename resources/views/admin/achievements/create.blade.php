                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" id="title" name="title" 
                                    ...
                                    placeholder="Contoh: Juara 1 Olimpiade Sains Nasional (OSN) Fisika" value="{{ old('title') }}" required>
                            ...
                            <div>
                                ...
                                <select id="category" name="category" required class="w-full rounded-xl border-slate-200 shadow-sm focus:border-primary focus:ring focus:ring-primary/20 transition-colors py-3">
                                    <option value="Akademik & Keilmuan" {{ old('category') == 'Akademik & Keilmuan' ? 'selected' : '' }}>Akademik & Keilmuan (Sains)</option>
                                    <option value="Olahraga" {{ old('category') == 'Olahraga' ? 'selected' : '' }}>Olahraga / Atletik</option>
                                    <option value="Seni & Budaya" {{ old('category') == 'Seni & Budaya' ? 'selected' : '' }}>Seni & Kesenian</option>
                                    <option value="Keagamaan" {{ old('category') == 'Keagamaan' ? 'selected' : '' }}>Keagamaan</option>
                                    <option value="Non-Akademik Lainnya" {{ old('category') == 'Non-Akademik Lainnya' ? 'selected' : '' }}>Non-Akademik Lainnya</option>
                                </select>
                            ...
                            <div>
                                ...
                                <select id="level" name="level" required class="w-full rounded-xl border-slate-200 shadow-sm focus:border-primary focus:ring focus:ring-primary/20 transition-colors py-3">
                                    ...
                                    <option value="Sekolah / Antar Kelas" {{ old('level') == 'Sekolah / Antar Kelas' ? 'selected' : '' }}>Lokal / Sekolah</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" id="student_name" name="student_name" 
                                    class="w-full rounded-xl border-slate-200 shadow-sm focus:border-primary focus:ring focus:ring-primary/20 transition-colors py-3" 
                                    placeholder="Contoh: Budi Santoso" value="{{ old('student_name') }}" required>
                            ...
                            <div>
                                ...
                                <input type="text" id="achievement_year" name="achievement_year" 
                                    class="w-full rounded-xl border-slate-200 shadow-sm focus:border-primary focus:ring focus:ring-primary/20 transition-colors py-3" 
                                    placeholder="Contoh: 2026" value="{{ old('achievement_year') }}" required>
                                @error('achievement_year')<p class="text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                            </div>
                            
                            <!-- Foto -->
                            <div class="md:col-span-2">
                                <label for="image" class="block text-sm font-bold text-slate-700 mb-1">Foto Dokumentasi (Opsional)</label>
                                ...
                                <p class="text-slate-400 text-xs mt-1">Format: JPG, PNG, WEBP maksimal 2MB. Foto saat angkat piala/medali disarankan.</p>
