...
@section('content')
    ...
    <section class="relative bg-brand-dark py-20 lg:py-28 overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="https://images.unsplash.com/photo-1577896851231-70ef18881754?q=80&w=2000&auto=format&fit=crop" alt="Background Ekstrakurikuler" class="w-full h-full object-cover opacity-20">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <p class="text-slate-300 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                Wadah pengembangan bakat dan minat siswa SMA Negeri 1 Suwawa.
            </p>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-slate-100 p-6 sm:p-8 md:p-12 relative overflow-hidden group">
                ...
                <div class="relative z-10 text-center py-16 px-4 bg-slate-50 rounded-2xl border border-dashed border-slate-300">
                    ...
                    <p class="text-slate-500 max-w-md mx-auto mb-8">Informasi dan dokumentasi kegiatan setiap ekstrakurikuler sekolah sedang disiapkan. Silakan hubungi admin untuk memperbarui informasi ini.</p>
                </div>
