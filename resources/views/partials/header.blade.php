<header x-data="{ mobileMenuOpen: false }" class="sticky top-0 z-50 glass-effect shadow-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 bg-primary rounded-lg flex items-center justify-center text-white text-xl shadow-md p-1">
            ...
            <nav class="hidden lg:flex items-center space-x-6 xl:space-x-8 font-medium">
                ...
                <div class="relative group" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" x-transition.opacity class="absolute top-full left-0 w-48 bg-white shadow-xl rounded-b-lg py-2 border border-slate-100 z-50 ring-1 ring-black ring-opacity-5">
                        <a href="{{ route('profil.sejarah') }}" class="block px-4 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-primary hover:font-semibold transition">Sejarah</a>
                        <a href="{{ route('profil.visi-misi') }}" class="block px-4 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-primary hover:font-semibold transition">Visi Misi</a>
                        <a href="{{ route('profil.struktur-organisasi') }}" class="block px-4 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-primary hover:font-semibold transition">Struktur Organisasi</a>
                        <a href="{{ route('profil.fasilitas') }}" class="block px-4 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-primary hover:font-semibold transition">Fasilitas</a>
                    </div>
                </div>
                ...
                <div class="relative group" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" x-transition.opacity class="absolute top-full left-0 w-48 bg-white shadow-xl rounded-b-lg py-2 border border-slate-100 z-50 ring-1 ring-black ring-opacity-5">
                        <a href="{{ route('akademik.guru-staf') }}" class="block px-4 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-primary hover:font-semibold transition">Guru & Staf</a>
                        <a href="{{ route('akademik.kurikulum') }}" class="block px-4 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-primary hover:font-semibold transition">Kurikulum</a>
                    </div>
                </div>
                ...
                <div class="relative group" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" x-transition.opacity class="absolute top-full left-0 w-48 bg-white shadow-xl rounded-b-lg py-2 border border-slate-100 z-50 ring-1 ring-black ring-opacity-5">
                        <a href="{{ route('kesiswaan.osis-mpk') }}" class="block px-4 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-primary hover:font-semibold transition">OSIS / MPK</a>
                        <a href="{{ route('kesiswaan.ekstrakurikuler') }}" class="block px-4 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-primary hover:font-semibold transition">Ekstrakurikuler</a>
                        <a href="{{ route('kesiswaan.prestasi') }}" class="block px-4 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-primary hover:font-semibold transition">Prestasi</a>
                    </div>
                </div>
                ...
                <div class="relative group" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                    ...
                    <div x-show="open" x-transition.opacity class="absolute top-full left-0 w-48 bg-white shadow-xl rounded-b-lg py-2 border border-slate-100 z-50 ring-1 ring-black ring-opacity-5">
                        <a href="#" class="block px-4 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-primary hover:font-semibold transition">PPDB Online</a>
                        <a href="#" class="block px-4 py-2.5 text-sm text-slate-600 hover:bg-blue-50 hover:text-primary hover:font-semibold transition">Download Center</a>
                    </div>
                </div>
                
                <!-- CTA Portal Login -->
                <a href="{{ route('login') }}" class="bg-primary hover:bg-blue-700 text-white px-6 py-2.5 rounded-full font-semibold transition flex items-center gap-2 text-sm shadow-[0_4px_10px_rgba(37,99,235,0.3)] ml-2 border border-blue-600 lg:px-6">
                    <i class="fa-solid fa-right-to-bracket text-blue-100"></i> Portal Login
                </a>
            </nav>
    ...
    <div x-show="mobileMenuOpen" x-transition.origin.top class="lg:hidden absolute top-full left-0 w-full bg-white shadow-xl border-t border-slate-100 py-4 px-4 flex flex-col h-auto max-h-[85vh] overflow-y-auto" x-cloak style="display: none;">
        ...
        <div class="mt-6 mb-2 flex flex-col gap-3">
            <a href="{{ route('login') }}" class="w-full bg-primary hover:bg-blue-700 text-white text-center py-3 rounded-xl font-semibold transition border border-blue-600 flex items-center justify-center gap-2">
